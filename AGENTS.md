...
This project is indexed by GitNexus as **SecretZero** (10500 symbols, 21810 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
