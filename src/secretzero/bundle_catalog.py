...
_TYPICAL_GENERATORS_BY_TARGET: dict[str, list[str]] = {
    ...
    "azdo_pipeline_variable": ["random_password", "random_string", "static", "azdo_pat"],
    "azdo_environment_variable": ["random_password", "random_string", "static", "azdo_pat"],
    "azdo_secure_file": ["random_password", "random_string", "static"],
    "azdo_keyvault_variable_group": ["random_password", "random_string", "static"],
